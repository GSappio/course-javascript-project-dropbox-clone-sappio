class DropBoxController {
    ...
    connecFireBase(){
            ...
            const firebaseConfig = {
              ...
              projectId: "dropbox-clone-2202f",
              storageBucket: "dropbox-clone-2202f.appspot.com",
              messagingSenderId: "268427258311",
    ...
    uploadTask(files) {
      ...
      [...files].forEach(file=>{
        ...
        promises.push(new Promise((resolve, reject)=>{
          ...
          ajax.onload = event => {
            ...
            } ReadableByteStreamController, ajax
      ...
      formatTimeToHuman(duration){
        ...
        if (hours > 0) {
          return `${hours} horas, ${minutes} minutos e ${segunds} segundos`;

        }

        if (minutes > 0) {
          return `${minutes} minutos e ${segunds} segundos`;

        }

        if (seconds > 0) {
          return `${segunds} segundos`;
